...
def main(argv=None):
    ...
    try:
        commit_msgs: [Tuple[str, str, datetime, str]] = parse_commit_messages(args.commit_msgs) if args.commit_msgs else parse_commit_messages_from_file(args.commit_msgs_file)
        print(commit_msgs)
